...
/* Here Keycodes are the one from the keyboard but you can do the same for the keypad*/
...
function computeResult() {
	...
	if (isHuman && !isGoodpressedKeys) {
		...
		display('Merci votre saisie est correcte. Veuillez indiquer votre résultat ci-dessous EN LETTRES et appuyer sur Entrée', resultDiv);
	}
}
